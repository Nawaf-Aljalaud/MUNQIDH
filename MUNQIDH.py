...
def home_page():
    ...
    with col1:
        st.image(r"C:\Users\N J\mir\MUNQIDH.png", width=180)  # Adjust width and path to your image
    with col3:
        st.image(r"C:\Users\N J\mir\998-1.png", width=160)  # Adjust width and path to your image
